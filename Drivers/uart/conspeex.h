...
str_speex_data parsing_str_data(char*);										// распарсивание строки в структуру str_speex_data
speex_data convert_speex_str_to_data(str_speex_data );						// перевод данных из структуры str_speex_data в str_speex_data
void print(speex_data );													// ф-ия печати speex_data(для отладки)
